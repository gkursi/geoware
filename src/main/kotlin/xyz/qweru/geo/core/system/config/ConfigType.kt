...
enum class ConfigType(val id: String, val systemFilter: SystemFilter, val settingFilter: SettingFilter) {
    ...
    MODULE("module", { _, module -> module is Module || module is Modules }, { _, setting -> !setting.hasUsage(SettingUsage.VISUAL) }),
    VISUAL("visual", { _, module -> module is Module || module is Modules }, { _, setting -> setting.hasUsage(SettingUsage.VISUAL) }),
    COLOR("color", { _, module -> module is Module || module is Modules }, { _, setting -> setting.hasUsage(SettingUsage.COLOR) }),
