...
fun PlayerEntity.inRange(range: Float) = this.squaredDistanceTo(mc.player?.eyePos ?: Vec3d.ZERO) <= MathHelper.square(range)
...
fun PlayerEntity.visiblePoint() = WorldHelper.blockCollision(this.world, mc.player?.eyePos ?: Vec3d.ZERO, this.boundingBox)
